...
// new ticket, resolves an existing one, or adds a support response (a noise
// event that should produce no change in queue_stats).
//
...
print("activity.js running — Ctrl+C to stop\n");
